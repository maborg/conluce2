...
export declare const filterMapEffect: {
    <A, X extends A, R2, E2, A2>(pf: (a: X) => Option.Option<Effect.Effect<R2, E2, A2>>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
    <R, E, A, X extends A, R2, E2, A2>(self: Stream<R, E, A>, pf: (a: X) => Option.Option<Effect.Effect<R2, E2, A2>>): Stream<R | R2, E | E2, A2>;
};
/**
