...
/** @internal */
export const as = /*#__PURE__*/dual(2, (self, value) => core.map(() => value)(self));
/** @internal */
export const asSome = self => core.map(Option.some)(self);
/** @internal */
export const asSomeError = self => mapError(Option.some)(self);
/** @internal */
export const asUnit = self => core.map(constVoid)(self);
/** @internal */
...
/** @internal */
export const check = predicate => suspend(() => predicate() ? unit : core.retry);
/** @internal */
...
/** @internal */
export const filter = /*#__PURE__*/dual(2, (iterable, predicate) => Array.from(iterable).reduce((acc, curr) => core.zipWith(predicate(curr), (as, p) => {
  if (p) {
    as.push(curr);
    return as;
  }
...
/** @internal */
export const head = self => core.matchSTM({
...
/** @internal */
export const mergeAll = /*#__PURE__*/dual(3, (iterable, zero, f) => suspend(() => Array.from(iterable).reduce((acc, curr) => core.zipWith(curr, f)(acc), core.succeed(zero))));
/** @internal */
export const negate = self => core.map(b => !b)(self);
/** @internal */
...
/** @internal */
export const orDieWith = /*#__PURE__*/dual(2, (self, f) => core.catchAll(core.die)(mapError(f)(self)));
/** @internal */
export const orElse = /*#__PURE__*/dual(2, (self, that) => core.flatMap(core.effect(journal => Journal.prepareResetJournal(journal)), reset => core.catchAll(() => core.flatMap(core.sync(reset), that))(core.orTry(self, () => core.flatMap(core.sync(reset), that)))));
/** @internal */
...
/** @internal */
export const reduce = /*#__PURE__*/dual(3, (iterable, zero, f) => suspend(() => Array.from(iterable).reduce((acc, curr) => core.flatMap(s => f(s, curr))(acc), core.succeed(zero))));
/** @internal */
export const reduceAll = /*#__PURE__*/dual(3, (iterable, initial, f) => suspend(() => Array.from(iterable).reduce((acc, curr) => core.zipWith(curr, f)(acc), initial)));
/** @internal */
export const reduceRight = /*#__PURE__*/dual(3, (iterable, zero, f) => suspend(() => Array.from(iterable).reduceRight((acc, curr) => core.flatMap(s => f(s, curr))(acc), core.succeed(zero))));
/** @internal */
...
/** @internal */
export const partition = /*#__PURE__*/dual(2, (elements, f) => core.map(as => effectCore.partitionMap(as, identity))(forEach(elements, a => either(f(a)))));
/** @internal */
...
/** @internal */
export const unit = /*#__PURE__*/core.succeed(void 0);
/** @internal */
